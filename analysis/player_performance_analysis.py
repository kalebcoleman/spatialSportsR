...
def load_enriched_shots(season=DEFAULT_SEASON):
    ...
    """
    data_path = ANALYSIS_DIR / f'shots_with_xp_{season}.parquet'
...
def generate_player_shot_chart(shots_df, player_name, season, output_dir=None):
    ...
    Args:
        ...
        season: Season identifier
        output_dir: Output directory (defaults to analysis/)
    """
...
if __name__ == "__main__":
    ...
    if not player_summary.empty:
        ...
        generate_player_shot_chart(shots_df, top_player, DEFAULT_SEASON, OUTPUT_DIR)
    
    # Save summary to CSV
    output_path = OUTPUT_DIR / 'player_summary.csv'
